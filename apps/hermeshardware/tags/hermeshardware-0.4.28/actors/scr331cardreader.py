# -*- coding: utf-8 -*-
#Módulo scr331cardreader- Módulo que implementa el "actor hardware" para los
#lectores de tarjetas SCR331-LC1 SmartCard Reader.
#
# Authors:
...
#         lectores de tarjetas SCR331-LC1 SmartCard Reader
# [en] gempluscardreader Module - SCR331-LC1 SmartCard Reader cardreader devices Actor
...
class Actor(PkgDeviceActor):
    ...
    [es] Implementación de la clase Actor para dispositivos lectores de
            tarjetas SCR331-LC1 SmartCard Reader.
    ---------------------------------------------------------------------------
    [en]  ACR38 SmartCard Reader devices Actor class implementation
    """
    __required__ = {
            "info.subsystem": "usb_device",
            "usb_device.vendor_id":0x04e6,
            "usb_device.product_id":0x5116}
    __icon_path__  = os.path.abspath('actors/img/scr331.png')
    __iconoff_path__ = os.path.abspath('actors/img/scr331off.png')
    __device_title__ = _("SCR331-LC1 SmartCard Reader")
