# -*- coding: utf-8 -*-
#Módulo acr38cardreader- Módulo que implementa el "actor hardware" para los
#lectores de tarjetas ACR38 SmartCard Reader.
#
# Authors:
...
#         lectores de tarjetas ACR38 SmartCard Reader
# [en] gempluscardreader Module - ACR38 SmartCard Reader cardreader devices Actor
...
class Actor(PkgDeviceActor):
    ...
    [es] Implementación de la clase Actor para dispositivos lectores de
            tarjetas ACR38 SmartCard Reader.
    ---------------------------------------------------------------------------
    [en]  ACR38 SmartCard Reader devices Actor class implementation
    """
    __required__ = {
            "info.subsystem": "usb_device",
            "usb_device.vendor_id":0x72F,
            "usb_device.product_id":0x90CC}
    __icon_path__  = os.path.abspath('actors/img/acr38.png')
    __iconoff_path__ = os.path.abspath('actors/img/acr38off.png')
    __device_title__ = _("ACR38 SmartCard Reader")
