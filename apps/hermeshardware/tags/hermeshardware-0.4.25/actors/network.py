...
#
# Authors:
#     Guadalinex V5 developers team
#     Jose Chaso (pchaso) <jose.chaso at gmail>
#
# [es] Modulo network - Módulo que implementa el "actor hardware" para 
#                       conexiones de red
# [en] network module - Implements hardware actor for networks connections
#
...
class Actor (DeviceActor):
    """ 
    [es] Implementacion de clase Actor para conexiones de red
    --------------------------------------------------------------------------
    [en] Actor class implementation for network connections
    """
    
#    interface = self.properties['net.interface']
    
    __required__ = {"linux.subsystem":"net"}
    __icon_path__  = os.path.abspath('actors/img/network.png')
    __iconoff_path__ = os.path.abspath('actors/img/networkoff.png')
    __device_title__ = _("Network")
#    __device_conn_description__ = _("Connected network interface %s") % interface
#    __device_disconn_description__ = _("Disconnected network interface %s") % interface
