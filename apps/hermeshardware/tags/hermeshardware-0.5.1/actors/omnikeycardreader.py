...
#
# [es] Modulo omnikeycardreader - Módulo que implementa el "actor hardware" 
#                        para los lectores de tarjetas Omnikey Cardman 3121
# [en] omnikeycardreader module - Implements hardware actor for 
#                        Omnikey Cardman 3121 cardreader
#
...
class Actor(PkgDeviceActor):
    """ 
    [es] Implementacion de clase Actor para lectores de tarjetas Omnikey 
         Cardman 3121
    --------------------------------------------------------------------------
    [en] Actor class implementation for Omnikey Cardman 3121 cardreader
    """
    __required__ = {
